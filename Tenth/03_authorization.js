...
const port = 700; // this is the same program as previous one, as running on different port
// we can access data on any server at any port as the information stored in the token
